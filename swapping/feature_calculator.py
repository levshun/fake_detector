...
from swapping.preprocessing.face_feature_extractor_main import FaceFeatureExtractor
...
def get_landmark_points(landmarks):
    ...
    for landmark in landmarks:
        ...
        points_mas.append(point)
    return np.asarray(points_mas)
...
def calculate_features_one(image_path: str) -> pd.DataFrame:
    ...
    with mp_face_mesh.FaceMesh(
        ...
        base_features_names = ['face_k', 'l_eye_k', 'r_eye_k', 'mouth_k', 'k1_l', 'k1_r', 'k2_l', 'k2_r', 'k3_l',
                               'k3_r']
