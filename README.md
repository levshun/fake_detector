...
Результаты НИОКР могут применяться по следующим направлениям:
...
Перечень направлений прикладного использования рекомендуется поддерживать в репозитории открытой библиотеки (в т.ч. на русском языке) и актуализировать по мере развития функциональности.
</p>
