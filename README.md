...
Онлайн-документация проекта представлена на сайте Read the Docs: 
[https://fake-detector.readthedocs.io](https://fake-detector.readthedocs.io).
</p>
...
Данная библиотека была протестирована для языка программирования Python версии 3.11.

Процесс установки:

Шаг 1. Создайте проект в Python IDE, скопировав его из VCS по ссылке
[```https://github.com/levshun/fake_detector/```](https://github.com/levshun/fake_detector/).
Также можно сделать это из консоли, запустив команду:
...
Шаг 2. Настройте интерпретатор в Python IDE, взяв за основу Python 3.11. 
Используйте виртуальную среду ```.venv``` для установки зависимостей.

Шаг 3. Необходимые версии сторонних библиотек (зависимости) представлены в файле ```requirements.txt```. 
Если библиотеки не были установлены при создании проекта, это можно сделать вручную с помощью следующей команды:
...
Шаг 5. Выгрузите архив с предобученными моделям по ссылке:
...
В корне проекта должна появиться структура каталогов и файлов следующего вида:
...
Зеркало репозитория доступно на GitLab: 
